...
class MTSRepairApp(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("MTS Repair Tool")
        ...
        self.repair_button.clicked.connect(self.repair_all_mts_files)
    ...
    def browse_reference_file(self):
        reference_file, _ = QFileDialog.getOpenFileName(self, "Select Reference MTS File", "", "MTS Files (*.MTS)")
        if reference_file:
